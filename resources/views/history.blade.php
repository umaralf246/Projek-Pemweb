<x-app-layout>
    ...
    <div class="max-w-6xl mx-auto px-4 py-10">
        <h1 class="text-3xl font-bold text-green-800 mb-8 text-center">Riwayat Event</h1>
        ...
        <div class="grid gap-8 grid-cols-1 md:grid-cols-2">
            ...
            <div class="bg-white rounded-lg shadow hover:shadow-md overflow-hidden transition">
                ...
                <div class="p-6">
                    <h2 class="text-xl font-semibold text-green-700 mb-2">Event {{ $i }}</h2>
                    <p class="text-gray-600 mb-4">Deskripsi singkat event ini menjelaskan isi atau manfaat eventnya.</p>
                    <a href="{{ url('/feedback/' . $i) }}" class="inline-block bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 transition">
                        Beri Feedback
                    </a>
                </div>
            </div>
